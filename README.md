...
Este proyecto aprovecha el siguiente stack tecnológico para garantizar un procesamiento de datos robusto y un modelado de alto rendimiento:

* **Lenguaje:** Python 3.14
* **Manipulación de datos:** Pandas, NumPy
* **Visualización:** Matplotlib, Seaborn
* **Modelado y ML:** Scikit-Learn (Ridge, Stacking), XGBoost, LightGBM
* **Entorno:** Kaggle Kernels (Jupyter Notebooks)
